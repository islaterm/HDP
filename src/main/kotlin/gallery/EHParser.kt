 ...
 */
class EHParser(private val galleriesDataFile: File? = null, private val galleriesTagsFile: File? = null) {
    ...
    fun parseToTSV(save: Boolean, vararg urls: String): Pair<String, String> {
        ...
        while (urlsToParse.isNotEmpty()) {
            ...
            val galleries = ObjectMapper().readValue("${response.jsonObject["gmetadata"]}", ArrayList::class.java)
